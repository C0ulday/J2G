public class TestPlateau {
    public static void main(String[] args) {
        ...
        // Crée un cavalier
        cavalier cavalierBlanc = new cavalier(3, 2, 3, 2, "BLANC", plateau);

        // Place le cavalier sur le plateau
        plateau.placerPiece(cavalierBlanc, 3, 2);
        ...
        Piece pionNoir = new Piece("PION", 7, 3, 7, 3, "NOIR", plateau);
        Piece pionBlanc = new Piece("PION", 4, 1, 4, 1, "BLANC", plateau);
        plateau.placerPiece(pionNoir, 5, 5);
        System.out.println("Coordonnées jouables après déplacement pion noir: " + pionNoir.getPositionX() + pionNoir.getPositionY());

        plateau.placerPiece(pionBlanc, 4, 1);
